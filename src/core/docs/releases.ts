...
export const RELEASES: Release[] = [
	{
		...
		added: [
			...
			"**The documentation reads on a phone or a tablet**: the contents slide out from a Contents button in the header, and the page takes the width. Tap beside them to put them away.",
		],
		changed: [
