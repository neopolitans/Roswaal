...
export const RELEASES: Release[] = [
	{
		...
		added: [
			...
			"**Undo, Redo, Align, Copy, Cut, Duplicate, Delete and Paste are buttons under the graph** on a phone or a tablet — Undo and Redo always, the rest while there is something for them to act on. Node Design's logic graph has the same bar.",
