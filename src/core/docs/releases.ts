...
export const RELEASES: Release[] = [
	{
		...
		added: [
			...
			"**Toolbars draws each bar on a computer, a tablet and a phone**, under tabs named as the rest of the documentation names them, with the two bars only a touch screen has — the action row, and Node Design's bar over a node — at the end. A tablet's and a phone's bar is drawn at that screen's width, and lists only what differs.",
