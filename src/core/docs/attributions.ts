...
export const ATTRIBUTIONS: Attribution[] = [
	...
	},
	{
		...
		licence: "CC-BY-4.0",
		where:
			"`src/core/robloxMembers.ts`, generated by `scripts/build-members.mjs`: " +
			"the one-line summaries of services' methods and their parameters, " +
			"shown in the editor and on the node pages.",
		note:
